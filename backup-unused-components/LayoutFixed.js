...
export default function Layout({ children }) {
  ...
  useEffect(() => {
    ...
    <div className="min-h-screen relative bg-gradient-to-br from-blue-50 via-indigo-50/90 to-purple-50/90 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950">
      ...
      <div className="fixed inset-0 bg-[radial-gradient(circle_at_center,_rgba(14,165,233,0.05),_transparent_70%)] dark:bg-[radial-gradient(circle_at_center,_rgba(14,165,233,0.07),_transparent_70%)] pointer-events-none"></div>
