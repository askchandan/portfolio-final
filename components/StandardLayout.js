        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">            <Link href="/" className="text-xl font-bold bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent dark:from-blue-400 dark:to-purple-400 transition-all duration-300 ease-in-out">
            ...
            <div className="flex items-center space-x-4">              {/* Theme Toggle */}              <button
                ...
                className="p-2 rounded-md hover:bg-gray-100 dark:hover:bg-gray-800 transition-all duration-300 ease-in-out"
              >
                {mounted && (
                  theme === 'dark' ? 
                  <SunMedium size={20} className="text-yellow-500 transition-all duration-300 ease-in-out" /> :
                  <Moon size={20} className="text-purple-500 transition-all duration-300 ease-in-out" />
                )}
              </button>
